              ...
              <div className="absolute z-20 top-0 left-8 right-8 h-px bg-gradient-to-r from-transparent via-purple-500/90 to-transparent" />
                <div>
                  <img
                    ...
                    alt="Login Background"
                    className="absolute z-30 inset-0 w-full h-full object-cover opacity-60"
                  />
                </div>

                <div
                  className={`relative z-10 w-full max-w-sm mx-auto transition-all duration-700 delay-200 ${
