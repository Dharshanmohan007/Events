...
import { Bell, Calendar, Check, CircleQuestionMark, ExternalLink, Filter, Hourglass, Search, Settings } from 'lucide-react'
                ...
                <tbody>
                    {requestRows.map((row, index) => (
                        <tr key={index} className="border-t border-[#20283a] text-xs text-white">
                            ...
                            <td className="px-4 py-4"><button className="text-[#8b93a7] hover:text-white"><ExternalLink size={15} /></button></td>
                        </tr>
                    ))}
                </tbody>
            </table>
