...
const DeleteConfirmationPopup = ({
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm">
        <div className="w-[430px] rounded-2xl border border-[#30304f] bg-[#211f3d]/20 px-7 py-6 text-center shadow-2xl">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
                ...
                <button
                    ...
                    onClick={onDelete}
                    disabled={deleting}
                    className="h-11 rounded-xl bg-[#ff3045b9]/80 text-sm font-semibold text-white hover:bg-[#ff4256]/80 disabled:cursor-not-allowed disabled:opacity-60"
                >
