                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <ExpandableListCell values={event.venues} />
                      </td>
                      <td className="px-6 py-4">
                        <ExpandableListCell values={event.dates} />
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        {event.department}
                      </td>
