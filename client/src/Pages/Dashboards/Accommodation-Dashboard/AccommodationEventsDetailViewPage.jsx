...
const AccommodationEventsDetailViewPage = () => {
    ...
    <section className="min-h-screen bg-[#0b1326] poppins">
      ...
      <main className="px-6 pb-8">
        <div className="flex items-center gap-2 py-3 text-sm text-[#CBC3D7]/50">
          <Link to="/dashboard-accommodation" className="hover:text-white transition-colors">
            Accommodation Dashboard
          </Link>
          <ChevronRight size={14} />
          <span className="text-[#D0BCFF]">{eventName || 'Accommodation Details'}</span>
        </div>
          ...
          {loading ? (
            ...
            <>
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h2 className="text-lg font-medium text-[#8B3DFF]">Accommodation Details</h2>
...
export default AccommodationEventsDetailViewPage
