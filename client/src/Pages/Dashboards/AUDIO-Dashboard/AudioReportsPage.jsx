    ...
    ;(async () => {
      try {
        const res = await fetch(
          `${API_BASE_URL}/api/table/dashboard-table?module=audio`,
  ...
  return (
    <div className="flex h-screen flex-col bg-[#0b1326] font-poppins text-white">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6">
        {/* Page Header — title/subtitle only, no tab toggle */}
        <div className="mb-6">
          <h1 className="text-xl font-semibold tracking-wide">Audio Reports</h1>
          <p className="mt-1 text-xs text-[#FFFFFF66]">View and manage audio requests</p>
        </div>
