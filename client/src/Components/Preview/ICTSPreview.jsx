  ...
  return (
    <div className="flex flex-col gap-6 bg-[#161B2D] rounded-xl border border-[#2E3652] p-6 text-white">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h2 className="text-purple-400 text-xl font-bold playfair">ICTS Details</h2>
        </div>
      </div>
                ...
                >
                  <div className="flex flex-col py-1">
                    ...
                    <InfoRow
                      ...
                      value={card.internetFacility || "-"}
                    />

                    <InfoRow
                      label="Expected Internet Users"
                      value={card.expectedInternetUsers ?? 0}
                    />
                    ...
                    {card.proctorUsers !== undefined &&
                      card.proctorUsers !== "" && (
                        <InfoRow
                          ...
                          value={card.proctorUsers}
                        />
                      )}

                    <InfoRow
                      label="Guest Wi-Fi Needed"
                      value={card.guestWifi || "-"}
                    />

                    {card.guestWifi === "Yes" && (
                      <InfoRow
                        label="If Guest Wi-Fi Exceeds 5"
                        value={card.guestWifiExceed5 || "-"}
                      />
                    )}

                    {card.guestWifiExceed5 === "Yes" && (
                      <InfoRow
                        label="Total Number of Guest WIFI Count"
                        value={card.totalGuestCount ?? 0}
                      />
                    )}
                  </div>
                </SectionCard>
