...
//   // ── FIX: ref that always holds the latest dayData ────────────────────────
...
//   // ── FIX: derive current from ref so it's always the latest value ─────────
//   // We still keep the state-derived `current` for rendering, but validation
//   // and submission will use dayDataRef.current (see handleNext below).
...
//   // ── FIX: handleNext reads dayDataRef.current instead of stale closure ────
//   const handleNext = useCallback(async () => {
//     const latestDayData = dayDataRef.current;
//     const currentDayData = latestDayData[currentDayIndex] || {};
...
//   // ── removed `current` and `dayData` from deps — we use the ref now ───────
