...
// // ─── Reusable Multi-Select Dropdown (same pattern as VenueForm/IctsForm) ─────
...
// // ─── File Upload (same dashed zone style) ────────────────────────────────────
...
//   if (data.displayNeeded?.includes("Flex") && !data.sizeForFlex?.trim())
//     e.sizeForFlex = "Size for Flex is required";
//   if (data.displayNeeded?.includes("Glass Sticker") && !data.sizeForGlass?.trim())
//     e.sizeForGlass = "Size for Glass Sticker is required";
...
//   if (!data.preEvent || data.preEvent.length === 0)
//     e.preEvent = "Select at least one option";
//   if (!data.eventCoverage || data.eventCoverage.length === 0)
//     e.eventCoverage = "Select at least one option";
//   if (!data.postEvent || data.postEvent.length === 0)
//     e.postEvent = "Select at least one option";
//   if (!data.specialVideos || data.specialVideos.length === 0)
//     e.specialVideos = "Select at least one option";
//   if (!data.deliveryDate) e.deliveryDate = "Delivery date is required";
//   if (!data.priority) e.priority = "Priority is required";
//   return e;
// }
...
//   const e = {};
//   if (!data.designType) {
//     e.designType = "Please select a design type";
//     return e;
//   }
...
//               errors.contentPoster ? "border-red-400" : "border-[#3A3A5A]"
...
//             placeholder="content"
//             className={`w-full bg-transparent border ${
//               errors.contentCertificate ? "border-red-400" : "border-[#3A3A5A]"
//             } text-white rounded-lg p-4 text-sm focus:outline-none focus:border-purple-500 resize-none placeholder-gray-600`}
//           />
//         </div>
...
//         value={data.referenceCertificate}
...
//             placeholder="content"
//             className={`w-full bg-transparent border ${
//               errors.contentTrophy ? "border-red-400" : "border-[#3A3A5A]"
//             } text-white rounded-lg p-4 text-sm focus:outline-none focus:border-purple-500 resize-none placeholder-gray-600`}
//           />
//         </div>
...
//       {/* Conditional: Size for Flex */}
//       {showFlex && (
//         <div className="rounded-lg border border-purple-500/30 bg-purple-600/5 p-4">
//           <CustomInput
//             labelBg="#1a1a2e"
//             label="Size for Flex *"
//             value={data.sizeForFlex || ""}
//             onChange={updateInput("sizeForFlex")}
...
//       {/* Conditional: Size for Glass Sticker */}
//       {showGlass && (
//         <div className="rounded-lg border border-purple-500/30 bg-purple-600/5 p-4">
//           <CustomInput
//             labelBg="#1a1a2e"
//             label="Size for Glass Sticker *"
//             value={data.sizeForGlass || ""}
//             onChange={updateInput("sizeForGlass")}
//             placeholder="e.g. A4"
//           />
...
//             onChange={updateInput("deliveryDate")}
//           />
...
//             onChange={updateInput("specialReq")}
//             rows={3}
//             placeholder="notes"
...
//           </span>
//           <textarea
//             value={data.contentVideo || ""}
//             onChange={updateInput("contentVideo")}
//             rows={3}
//             placeholder="content"
//             className={`w-full bg-transparent border ${
//               errors.contentVideo ? "border-red-400" : "border-[#3A3A5A]"
//             } text-white rounded-lg p-4 text-sm focus:outline-none focus:border-purple-500 resize-none placeholder-gray-600`}
//           />
//         </div>
...
//           selected={data.preEvent || []}
//           onChange={update("preEvent")}
//           error={errors.preEvent}
//         />
//       </div>
...
//           options={EVENT_COVERAGE_OPTIONS}
//           selected={data.eventCoverage || []}
//           onChange={update("eventCoverage")}
//           error={errors.eventCoverage}
//         />
//       </div>
...
//           selected={data.postEvent || []}
//           onChange={update("postEvent")}
//           error={errors.postEvent}
//         />
//       </div>
...
//           options={SPECIAL_VIDEO_OPTIONS}
//           selected={data.specialVideos || []}
//           onChange={update("specialVideos")}
//           error={errors.specialVideos}
//         />
//       </div>
...
// export default function MediaForm({ nextStep, prevStep, eventDays = [] }) {
//   const [currentDayIndex, setCurrentDayIndex] = useState(0);
//   const [completedDays, setCompletedDays] = useState([]);
//   const [errors, setErrors] = useState({});

//   // mediaData[dayIndex] = { designType, poster: {...}, video: {...} }
//   const [mediaData, setMediaData] = useState(() =>
//     eventDays.map(() => emptyDayData())
//   );
...
//   const showPoster =
//     currentDay.designType === "Poster" || currentDay.designType === "Both";
//   const showVideo =
//     currentDay.designType === "Video" || currentDay.designType === "Both";
...
//   const updatePoster = (posterData) => {
//     updateDay({ poster: posterData });
//   };

//   const updateVideo = (videoData) => {
//     updateDay({ video: videoData });
//   };

//   const handleDesignTypeChange = (val) => {
//     updateDay({ designType: val });
//     // Clear type-level error on change
//     setErrors((prev) => {
//       const copy = { ...prev };
...
//       {/* Day Timeline — reused from VenueForm */}
//       <DayTimeline
//         days={eventDays}
...
//         >
//           {currentDayIndex === eventDays.length - 1 ? "Submit Form →" : "Next Day →"}
//         </button>
//       </div>
//     </div>
//   );
