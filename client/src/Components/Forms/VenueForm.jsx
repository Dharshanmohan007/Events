...
// export default function VenueForm({ nextStep, prevStep, eventDays = [], onVenueDataChange }) {
...
//       // Notify parent with latest full venue data
...
//         <button onClick={handleBack} className="border border-purple-600 px-6 py-2 rounded text-purple-600">← Back</button>
//         <button onClick={handleNext} className="bg-purple-600 px-6 py-2 rounded text-white">
...
export default function VenueForm({ nextStep, prevStep, eventDays = [], onVenueDataChange, eventId }) {
  const [currentDayIndex, setCurrentDayIndex] = useState(0);
  const [completedDays, setCompletedDays] = useState([]);
  const [errors, setErrors] = useState({});
