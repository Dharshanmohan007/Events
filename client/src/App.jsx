...
// admin individual detail view v2
...
function AppRoutes() {
  return (
    <Routes>
      ...
      />
      <Route
        path="/dashboard-ictcs/events/:eventId"
        element={
          <ProtectedRoute>
            <IctcEventDetailsPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-ictcs/events/detailView/:eventId"
        element={
          <ProtectedRoute>
            <IctcsEventsDetailViewPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-ictcs/reports"
        element={
          <ProtectedRoute>
            <Reports />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/dashboard-audio/events/detailView/:eventId"
        element={
          <ProtectedRoute>
            <AudioEventsDetailViewPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-audio/reports"
        element={
          <ProtectedRoute>
            <AudioReportsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/dashboard-transports/events"
        element={
          <ProtectedRoute>
            <TransportEventsListPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-transports/events/detailView/:eventId"
        element={
          <ProtectedRoute>
            <TransportEventsDetailViewPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-transports/events/individualDetailView/:id"
        element={
          <ProtectedRoute>
            <TransportIndividualDetailViewPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-transports/reports"
        element={
          <ProtectedRoute>
            <TransportsReportsPage />
          </ProtectedRoute>
        }
      />
      ...
      />
      <Route
        path="/dashboard-media/events/detailView/:eventId"
        element={
          <ProtectedRoute>
            <MediaEventsDetailViewPage />
          </ProtectedRoute>
        }
      />
      {/* individual media detail view v2  */}
      <Route
        path="/dashboard-media/individualDetailView/:eventId"
        element={
          <ProtectedRoute>
            <HeadIndividualDetailView />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-media/reports"
        element={
          <ProtectedRoute>
            <MediaReportsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/dashboard-poster/requests"
        element={
          <ProtectedRoute>
            <PosterRequestListPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-poster/reports"
        element={
          <ProtectedRoute>
            <PosterReportsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/dashboard-poster/feedback"
        element={
          <ProtectedRoute>
            <PosterFeedbackPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/dashboard-poster/detailView/:posterId"
        element={
          <ProtectedRoute>
            <PosterDetailView />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/dashboard-poster/individualDetailView/:id"
        element={
          <ProtectedRoute>
            <PosterIndividualDetailViewPage />
          </ProtectedRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/dashboard-video/requests"
        element={
          <ProtectedRoute>
            <VideoRequestListPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-video/detailView/:videoId"
        element={
          <ProtectedRoute>
            <VideoDetailView />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/dashboard-video/individualDetailView/:id"
        element={
          <ProtectedRoute>
      ...
      >
        ...
        <Route
          path="AdminEventsRequests/:eventId"
          element={<HodEventDetailsPage />}
        />
        <Route
          path="individual-submissions/:id"
          element={<HodIndividualEventDetailPage />}
        />
      </Route>

      <Route
        path="/dashboard/IndividualEvents/:eventId"
        element={
          <ProtectedRoute>
            <HeadIndividualDetailView />
          </ProtectedRoute>
      ...
      <Route
        path="/individual-transport/edit/:id"
      ...
      <Route
        path="/IndividualFoodAndRefreshment"
        element={<IndividualFoodAndRefreshmentPage />}
      />
      <Route
        path="/IndividualFoodAndRefreshment/edit/:id"
        element={<IndividualFoodAndRefreshmentPage />}
      />
      <Route
        path="/individual-food/edit/:id"
        element={<IndividualFoodAndRefreshmentPage />}
      />
      ...
      <Route
        path="/individual-purchase/edit/:id"
      ...
      <Route
        ...
        element={
          <ProtectedRoute>
            <FacultyEventsListPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-faculty/events/detailView/:eventId"
        element={
          <ProtectedRoute>
            <FacultyEventsDetailViewPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-faculty/events/detailView/:eventId/documentUpload"
        element={
          <ProtectedRoute>
            <FacultyDocumentUploadPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-faculty/individual-requests/:id"
        element={
          <ProtectedRoute>
            <FacultyIndividualRequestDetailViewPage />
          </ProtectedRoute>
        }
      />
      {/* faculty individual detail view v2  */}
      <Route
        path="/dashboard-faculty/individual-detailView/v2/:eventId"
        element={
          <ProtectedRoute>
            <FacultyIndividualDetailiew />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-faculty/venues"
        element={
          <ProtectedRoute>
            <FacultyVenueListPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-faculty/feedback/:eventId"
        element={
          <ProtectedRoute>
            <FacultyfeedbackPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/dashboard-faculty/individual-feedback/:requestId"
        element={
          <ProtectedRoute>
            <FacultyIndividualFeedbackPage />
          </ProtectedRoute>
        }
      />
      ...
      />
      <Route
        path="/dashboard-faculty/PurchaseIndividualDocumentUpload/:eventId"
        element={
          <ProtectedRoute>
            <PurchaseIndividualDocumentUpload />
          </ProtectedRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/dashboard-faculty/MediaIndividualDocumentUpload/:eventId"
        element={
          <ProtectedRoute>
            <MediaIndividualDocumentUpload />
          </ProtectedRoute>
        }
      />
      ...
      />
      <Route
        path="/dashboard-accommodation/requests"
        element={
          <ProtectedRoute>
            <AccommodationRequestListPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-accommodation/events/detailView/:eventId"
        element={
          <ProtectedRoute>
            <AccommodationEventsDetailViewPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-accommodation/reports"
        element={
          <ProtectedRoute>
            <AccommodationReportsPage />
          </ProtectedRoute>
        }
      />
      ...
      />
      <Route
        path="/dashboard-venue/requests"
        element={
          <ProtectedRoute>
            <VenueRequestListPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-venue/events/detailView/:eventId"
        element={
          <ProtectedRoute>
            <VenueEventsDetailViewPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-venue/reports"
        element={
          <ProtectedRoute>
            <VenueReportsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/dashboard-food/events/detailView/:eventId"
        element={
          <ProtectedRoute>
            <FoodEventsDetailViewPage />
          </ProtectedRoute>
        }
      />
      {/* Food individual detail view v2 */}
      <Route
        path="/dashboard-food/events/individualDetailView/:eventId"
        element={
          <ProtectedRoute>
            <HeadIndividualDetailView />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/dashboard-purchase/events"
        element={
          <ProtectedRoute>
            <PurchaseEventsListPage />
          </ProtectedRoute>
        }
      />
      <Route
        path="/dashboard-purchase/events/detailView/:eventId"
        element={
          <ProtectedRoute>
            <PurchaseEventsDetailViewPage />
          </ProtectedRoute>
        }
      />
      <Route
