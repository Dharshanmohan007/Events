        ...
        {ratingOptions.map((option) => {
          ...
          return (
            <button
              ...
              className={`flex h-[67px] w-[67px] cursor-pointer flex-col items-center justify-center rounded-lg border text-center transition-all duration-200 sm:w-[80px] ${isSelected
