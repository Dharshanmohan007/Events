...
const PurchaseDepartmentPieChart = ({ data, title = "Purchase Requests By Department" }) => {
    const [selectedFilter, setSelectedFilter] = useState('All')

    const filterOptions = ['All', 'Electronics', 'Stationery', 'Furniture', 'Lab Equipment']

    const filteredData = selectedFilter === 'All' 
        ? data 
        : data.filter(item => item.category === selectedFilter || item.category === undefined)
...
export default PurchaseDepartmentPieChart